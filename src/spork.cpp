...
void CSporkManager::ExecuteSpork(int nSporkID, int nValue)
{
    ...
    if(nSporkID == SPORK_12_RECONSIDER_BLOCKS && nValue > 0) {
        ...
        if(GetTime() - nTimeExecuted < nTimeout) {
            LogPrint(DYNLog::SPORK, "CSporkManager::ExecuteSpork -- ERROR: Trying to reconsider blocks, too soon - %d/%d\n", GetTime() - nTimeExecuted, nTimeout);
            return;
        }
...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)) {
        ...
        case SPORK_14_REQUIRE_SENTINEL_FLAG:
            ...
            break;
        default:
            LogPrint(DYNLog::SPORK, "CSporkManager::IsSporkActive -- Unknown Spork ID %d\n", nSporkID);
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    case SPORK_8_DYNODE_PAYMENT_ENFORCEMENT:
        return SPORK_8_DYNODE_PAYMENT_ENFORCEMENT_DEFAULT;
    case SPORK_9_SUPERBLOCKS_ENABLED:
        return SPORK_9_SUPERBLOCKS_ENABLED_DEFAULT;
    case SPORK_10_DYNODE_PAY_UPDATED_NODES:
        return SPORK_10_DYNODE_PAY_UPDATED_NODES_DEFAULT;
    case SPORK_12_RECONSIDER_BLOCKS:
    ...
    default:
        LogPrint(DYNLog::SPORK, "CSporkManager::GetSporkValue -- Unknown Spork ID %d\n", nSporkID);
        return -1;
    }
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    LogPrint(DYNLog::SPORK, "CSporkManager::GetSporkIDByName -- Unknown Spork name '%s'\n", strName);
    return -1;
}
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    ...
    default:
        LogPrint(DYNLog::SPORK, "CSporkManager::GetSporkNameByID -- Unknown Spork ID %d\n", nSporkID);
        return "Unknown";
    }
}
